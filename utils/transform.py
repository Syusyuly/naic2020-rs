...
class Crop(object):
    ...
    def __call__(self, image, label):
        ...
        if pad_h > 0 or pad_w > 0:
            ...
            label = cv2.copyMakeBorder(label, pad_h_half, pad_h - pad_h_half, pad_w_half, pad_w - pad_w_half, cv2.BORDER_CONSTANT, value=0)
        h, w = label.shape
...
class RandRotate(object):
    ...
    def __init__(self, rotate, padding, p=0.5):
